...
def bronze_wb_nm_report_detail_daily_sensor(context):
    ...
    for token_id, token in rows:
        ...
        context.log.info(f"Scheduling wb_nm_report_detail_1d_job for token_id={token_id}")
        yield RunRequest(
            run_key=run_key,
